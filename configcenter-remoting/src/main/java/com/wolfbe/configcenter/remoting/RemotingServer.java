...
import com.wolfbe.configcenter.remoting.netty.NettyRequestProcessor;
...
public interface RemotingServer extends RemotingService {
    ...
    RemotingPair<NettyRequestProcessor, ExecutorService> getProcessorPair(final int requestCode);
